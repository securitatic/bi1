...
from bi_app.app import create_app
from bi_app.database import db
from bi_app.settings import DevConfig, ProdConfig
from bi_app.user.models import User

CONFIG = ProdConfig if os.environ.get('BI_APP_ENV') == 'prod' else DevConfig
